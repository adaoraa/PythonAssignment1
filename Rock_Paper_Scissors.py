...
while game_rules != 1: # condition allowing roop to run being that 1 is not = 0 which is true
    p1_choose = input('choose rock, paper, or scissors: ') # variable for player 1's move
    p2_choose = input('choose rock, paper, or scissors: ') # variable for player 2's move
    ...
    if p1_choose == rock and p2_choose == scissors: # rock > scissors
        ...
        print('Congrats ' + p2)
    elif (p1_choose != rock and p1_choose != paper and p1_choose != scissors) or (p2_choose != rock and p2_choose != paper and p2_choose != scissors): # error message
        print('Invalid choice, go again')
    else: # p1 and p2 choose same move
